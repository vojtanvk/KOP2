...
extern const std::map<size_t, MeasuredPerformanceEntry> measured_performance = {
    {20, {0.112, {.initial_temperature=2, .inner_loop_iterations=500, .min_temperature=0.1, .cooling_rate=0.1}}},
    ...
    {75, {0.02, {.initial_temperature=2, .inner_loop_iterations=1000, .min_temperature=0.00333, .cooling_rate=0.7}}},
    {100, {0.01, {.initial_temperature=2, .inner_loop_iterations=1000, .min_temperature=0.001, .cooling_rate=0.8}}}
};
